            ...
            <div className="embla h-full" ref={emblaRef}>
                <div className="embla__container h-full">
                    {validTapestries.map((tapestry, index) => (
                        <div key={tapestry.slug || index} className="embla__slide h-full relative flex-[0_0_100%]">
                            <div
                                className="absolute inset-0 overflow-hidden"
                            >
                                <img
                                    src={tapestry.imagePath || tapestry.thumbnail || `/placeholder.svg?height=1080&width=1920`}
                            ...
                            <div className={cn("absolute inset-0 opacity-40", tapestry.background_color || "bg-colonial-navy")} />
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div className="absolute inset-0 z-20 flex flex-col items-center justify-center pointer-events-none">
                <div className="container mx-auto text-center px-6">
                    <div className="hero-content-box max-w-4xl mx-auto">
                        ...
                        >
                            <Link href={`/tapestry/${currentTapestry.slug}`}>Explore the {currentTapestry.title} tapestry</Link>
                        </Button>
                    </div>
                </div>
            </div>
                ...
                {validTapestries.map((_, index) => (
                    <button
                        ...
                        className={cn(
                            ...
                            currentIndex === index ? "bg-colonial-gold w-6" : "bg-colonial-parchment/60 hover:bg-colonial-parchment",
                        )}
