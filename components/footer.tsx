        ...
        <footer className="bg-colonial-navy border-t border-colonial-gold/30 py-12 text-colonial-parchment">
            <div className="container mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
                    <div>
                        <h3 className="font-sans font-bold text-lg mb-4 text-colonial-gold">America's Tapestry</h3>
                    ...
                    <div>
                        <h3 className="font-sans font-bold text-lg mb-4 text-colonial-gold">Quick Links</h3>
                    ...
                    <div className="sm:col-span-2 md:col-span-1">
                        <h3 className="font-sans font-bold text-lg mb-4 text-colonial-gold">Connect</h3>
                ...
                <div className="border-t border-colonial-gold/20 mt-8 pt-8 text-center text-colonial-parchment/60">
                    <p className="font-serif text-base">© {new Date().getFullYear()} America's Tapestry. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
