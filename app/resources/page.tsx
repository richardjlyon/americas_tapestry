    ...
    <PageSection background="colonial-parchment">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <Card className="bg-white shadow-md border border-colonial-navy/10 h-full flex flex-col">
          ...
          <CardContent className="flex-grow">
            <p className="font-serif text-colonial-navy/80">
              Access lesson plans, educational materials, historical fact
              sheets, and interactive activities designed for educators at all
              levels. Our resources are aligned with curriculum standards and
              cover various aspects of American history and textile arts.
            </p>
          </CardContent>
          <CardFooter>
            <Button
        ...
        <Card className="bg-white shadow-md border border-colonial-navy/10 h-full flex flex-col">
          ...
          <CardContent className="flex-grow">
            <p className="font-serif text-colonial-navy/80">
              ...
              stitching methods, materials, tools, and specialized terminology
              used throughout the America's Tapestry project.
            </p>
          </CardContent>
          <CardFooter>
            <Button
        ...
        <Card className="bg-white shadow-md border border-colonial-navy/10 h-full flex flex-col">
          ...
          <CardContent className="flex-grow">
            <p className="font-serif text-colonial-navy/80">
              Explore a curated collection of historical items and artefacts
              that inspired or are thematically connected to the America's
              Tapestry project. Each item is presented with historical context
              and its relationship to our tapestry panels.
            </p>
          </CardContent>
          <CardFooter>
            <Button
