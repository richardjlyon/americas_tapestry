    ...
    <div className="space-y-12">
      <div className="text-center max-w-3xl mx-auto">
        ...
        <p className="font-serif text-colonial-navy mb-4 md:mb-6 leading-relaxed">
          America's Tapestry is brought to life by a dedicated team of historians, artists, and craftspeople working
        ...
        {teamMembers.map((member) => (
          <div key={member.name} className="flex flex-col sm:flex-row gap-6 items-start">
            ...
            <div>
              ...
              <p className="font-serif text-colonial-burgundy mb-2 text-center sm:text-left">{member.role}</p>
              <p className="font-serif text-colonial-navy/80 leading-relaxed">{member.bio}</p>
            </div>
          </div>
        ))}
      </div>
