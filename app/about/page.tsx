    ...
    <>
      ...
      <PageSection>
        ...
        <div className="max-w-3xl mx-auto">
          <ContentCard
            className="content-typography vintage-paper overflow-hidden"
            padding="large"
          >
            <p className="font-bold">
              ...
              illustrate and mark our unique history, and to look forward to our
              next 250 years.
            </p>
            ...
            <p>
              ...
              University's prestigious College of Fine Arts, where he
              specialized in the dress and textiles of Colonial America. As a
              Fulbright Scholar, Stefan deepened his understanding of the
              discipline through his Masters Degree at the University of Glasgow
              in Scotland.
            </p>
            ...
            <p>
              ...
              of the original colonies. The embroidery will be conducted by
              talented artisans from New Hampshire to Georgia. The panels
              illustrate the diverse stories of individual contributions–many
              overlooked–that reveal each colony's struggle for Independence.
              Historical associations from across the states have volunteered to
              collaborate on the panels' historical imagery and have generously
            ...
            <blockquote>
              ...
              individuals working across the country to create a harmonious
              whole, it seemed to characterize one of the defining features of
            ...
            <p>
              ...
              the inaugural display at William & Mary's historic campus–a
              stone's throw away from Colonial Williamsburg, "America's
              Tapestry" will tour a number of other historic venues throughout
              the East Coast.
            </p>
            ...
            <p>
              ...
              manpower. Interested EGA members are encouraged to volunteer to
              work on this historic project. Each panel will be stitched from
              July 2025 to June 2026 at a historic institution within the
            ...
            <blockquote>
              ...
              important than ever to preserve a definitive art form that has
              contributed so much to our country's distinct artistic identity."
            </blockquote>
          </ContentCard>
        </div>
      </PageSection>
