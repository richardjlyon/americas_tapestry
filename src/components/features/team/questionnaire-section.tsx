    ...
    <div className="mb-content-lg">
      <div className="bg-colonial-navy p-8 text-center">
        ...
        <p className="text-colonial-parchment/90 mb-6 max-w-2xl mx-auto">
          As a valued member of our stitching community, your insights and experiences are 
          invaluable to the continued success of America's Tapestry. We invite you to share 
          your thoughts, suggestions, and stories through our brief questionnaire. Your 
          feedback will help us better support our stitching groups and enhance this 
