    ...
    >
      <CardHeader className="p-4 pb-0">
        <div className="flex justify-between items-start mb-2">
          <Badge className={`${tierColors[sponsor.tier]}`}>{sponsor.tier} Sponsor</Badge>
          <div className="text-sm text-colonial-navy/60">Since {sponsor.partnership_year}</div>
        </div>
      </CardHeader>
      <CardContent className="p-4 pt-2">
        <div className="flex flex-col items-center mb-4">
          ...
          <h3 className="text-xl font-bold text-colonial-navy text-center">{sponsor.name}</h3>
          <p className="text-sm text-colonial-navy/70 text-center">{sponsor.location}</p>
        </div>
        <p className="font-serif text-colonial-navy/80 line-clamp-3 text-sm">{sponsor.excerpt}</p>
      </CardContent>
      <CardFooter className="p-4 pt-0 flex justify-between">
        ...
        <Button asChild variant="ghost" size="sm" className="text-colonial-navy/70 hover:text-colonial-navy">
