  ...
  return (
    <main className="min-h-screen">
      <section
        className={cn(
          'min-h-screen',
          tapestry.background_color || 'bg-colonial-parchment',
        )}
      >
        <div className="container pt-16 md:pt-20 pb-16 md:pb-20">
          ...
          <div className="bg-colonial-parchment rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6 md:p-8">
              <h1 className="text-3xl md:text-4xl font-bold text-colonial-navy mb-4">
                {tapestry.title}
              </h1>
              <p className="font-serif text-xl text-colonial-navy/80 mb-8">
                {tapestry.summary}
              </p>
