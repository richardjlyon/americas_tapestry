      ...
      <main className="flex-1 pt-20 md:pt-24">
        <section className="bg-colonial-parchment py-12 md:py-16">
          <div className="container mx-auto">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-colonial-navy mb-8 text-center">Our Team</h1>
            ...
            <div className="space-y-12 md:space-y-16">
              <h2 className="text-2xl md:text-3xl font-bold text-colonial-navy text-center mb-8">
