    ...
    <section className="bg-colonial-parchment py-12 md:py-16">
      <div className="container mx-auto">
        ...
        {sponsors.filter((s) => s.tier === "Platinum").length > 0 && (
          <div className="mb-12">
            <h3 className="text-xl font-bold text-colonial-navy mb-6 text-center">Platinum Sponsor</h3>
            <div className="max-w-2xl mx-auto">
              <SponsorCard sponsor={sponsors.filter((s) => s.tier === "Platinum")[0]} featured={true} />
            </div>
          </div>
        )}
        ...
        {sponsors.filter((s) => s.tier === "Bronze").length > 0 && (
          <div className="mt-12">
            <h3 className="text-xl font-bold text-colonial-navy mb-6 text-center">Bronze Sponsors</h3>
              ...
              {sponsors
                ...
                .map((sponsor) => (
                  ...
                  >
                    ...
                    <h4 className="text-sm font-medium text-colonial-navy">{sponsor.name}</h4>
                  </div>
                ))}
            </div>
          </div>
        ...
        <div className="mt-16 text-center">
          <h3 className="text-xl font-bold text-colonial-navy mb-4">Become a Sponsor</h3>
          <p className="font-serif text-colonial-navy/80 max-w-2xl mx-auto mb-6">
            Join these distinguished organizations in supporting America's Tapestry. Your sponsorship helps us preserve
            and celebrate our nation's diverse cultural heritage through art, education, and community engagement.
          </p>
          <Button
            asChild
