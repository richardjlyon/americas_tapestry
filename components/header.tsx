    ...
    return (
        <header
            className={cn(
                ...
                isScrolled ? "bg-colonial-burgundy shadow-md" : "bg-colonial-burgundy/90 backdrop-blur-sm",
            )}
        >
            ...
            {isMobileMenuOpen && (
                <div className="fixed inset-0 bg-colonial-burgundy z-50 md:hidden">
                    ...
                    <nav className="flex flex-col items-center justify-center h-full space-y-8">
                        ...
                        <Link href="/support" className="mt-4 inline-block" onClick={handleNavClick}>
