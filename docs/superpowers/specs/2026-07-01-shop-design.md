...
America's Tapestry treats thirteen hand-embroidered colony panels as fine art in a modern museum-publication layout. The storefront reads as a **premium gallery bookstore**, not a costume-y heritage site: a gallery-white/parchment canvas with generous whitespace, oversized Montserrat 800 headlines, EB Garamond serif for descriptive and italic caption copy, delicate gold hairlines, and a single running-stitch motif used sparingly as a connective mark. Color is restrained — navy for text and dark art plates, gold reserved for CTAs / the stitch rule / active states, burgundy strictly for eyebrows, hovers, and the type chip. The landing leads with the **flagship hardcover** — *The Making of America's Tapestry* as a matted museum plate — the brand statement that binds all thirteen panels into one object (Richard's explicit merchandising decision; it overrides the taxonomy's ★-hero column for the hero slot only). **Wall art leads the product merchandising from beat two**: the Wall Art band (the four collector formats, art-only imagery, plus an **Exhibition Poster strip** — the navy-plate souvenir line, from $15). Then the **state-first spine** ("Find your state, bring its story home") — the 13-colony index of framed panel tiles — and finally the **curated entry points** as a four-door band (The 2026 Calendar, Gifts under $30, Collect all 13, For Institutions & Bulk). The whole surface is three reusable primitives (ProductCard, CatalogGrid, FilterRail) whose facets map directly to Shopify tags, so new product lines populate existing facets and the grid with **no new page types**.

**The Night Gallery treatment (adopted 2026-07-02, from `merch/_proofs/index.html`):** art-forward surfaces sit on a **deep-navy exhibition passage** — gradient ground `#2a3c5c → #1e2b45 → #141d2e`, entered through a centered gold "threshold" tick — where the real embroidery photography glows like textiles in a darkened gallery room. Inside the passage, artwork is **chrome-free**: no card borders, badges, or flags — just the image, a deep shadow (`0 10px 32px rgba(0,0,0,.45)`), a hover lift, and a quiet proofs-style caption (italic numeral/label + cream text, EB Garamond letterspaced small-caps headings, thin cream rules). Commerce surfaces (book hero, curated doors, catalog rail, product-detail buy column, footer) stay light for ergonomics — pages breathe **light → dark → light**. Applies to: the landing's Wall Art gallery + colony picker, and the state page's product gallery.

**Principles:** (1) State-first emotional spine. (2) Museum restraint — whitespace and hairlines over chrome. (3) One card, one grid, one rail — extensibility is visible. (4) Type hierarchy carries the design; the stitch is the only ornament. (5) AA-accessible contrast throughout. (6) **Dark rooms for art, light rooms for commerce** — the Night Gallery passage presents; the light frame sells.
...
| **Night Gallery navy** | `#1e2b45 → #141d2e` | Exhibition-passage gradient ground (onset via `#2a3c5c`) |
| **Gallery cream** | `#ECE7D4` | Headings/captions on the dark passage |
| **Gallery cream-dim** | `#c8c2ad` | Secondary text on dark, ≥14px only (use `#d8d2bd` below 14px) |

Night Gallery shadow: `0 10px 32px rgba(0,0,0,.45)` (hover: `0 16px 40px rgba(0,0,0,.6)` + 4px lift). Dark-passage headings: EB Garamond, uppercase/small-caps, letter-spacing `.22–.35em`, gallery cream. (Equity A Caps — the proofs page's face — is not web-licensed; EB Garamond approximates it.)
...
|---|---|---|
| `/shop` | **Landing** | **Book hero** (the hardcover is the brand statement) → Wall Art band (4 collector formats + Exhibition Poster strip) → 13-colony picker → curated-entries band (Calendar / Gifts under $30 / Collect all 13 / Institutions) → 250th story strip |
...
**01 Landing** — **Book hero leads** (flagship, on the parchment band): the real hardcover cover as a standing matted plate opposite *The Making of America's Tapestry*, the "A nation's story, stitched by hand" tagline, $45 · printed to order, **Add to cart** / **Look inside**, and a 62 Pages · 13 Colony Panels · 250 Years stat trio on dashed-gold borders (the book is a normal Shopify product, `book` tag, all-states; its detail page reuses ProductDetail). Then the **Night Gallery exhibition passage** (one continuous dark section, entered via the gold threshold tick) holding beats two and three: **(2) the Wall Art gallery** — four collector-line formats as chrome-free real-photography plates (Framed from $90 · Canvas from $90 · Metal & Acrylic from $150 · Art Prints from $25) plus the **Exhibition Poster strip** (real poster image, "the souvenir of the 250th," from $15); **(3) the 13-colony picker** — all thirteen real panel photographs, proofs-style captions (*italic numeral · state · Panel N · pieces*), plus the quiet navy/gold 14th "All 13" tile. Back to light for beat four: the **curated-entries band** — The 2026 Calendar ($35) · Gifts under $30 · Collect all 13 · For Institutions & Bulk. Close: navy story strip carrying the 250th commemorative theme, shared footer. Mockup imagery: web-sized proofs vendored at `2026-07-01-shop-design-mockups/assets/proofs/`.

**02 State (Georgia)** — Breadcrumb, asymmetric state hero on light (framed plate with the **real Georgia panel photograph** / story column, panel number, facts, dual CTA — primary "Shop Georgia Wall Art"; stats Panel III · 1732 · 7 Product Types). The product gallery is a **Night Gallery passage**: dark ground, cream jump-bar pills (gold active) over the seven types (All · Framed · Canvas · Metal & Acrylic · Art Prints · Exhibition Poster · Greeting Cards · Postcards), and the seven products as chrome-free real-photography plates in wall-art-led order (Framed from $90 → Canvas from $90 → Metal from $150 → Art Print from $25 → **Exhibition Poster from $15, real navy-plate poster image** → Greeting-Card Set $28 → Postcards $20 — card/postcard product photos pending, art photo stands in). Navy panel-story block with a real detail crop; back to light for the **"Complete the collection"** band (2026 Calendar + Book cover + Collect-all-13 tile + neighboring states with their real panel photos), footer.
...
**Restructured for the taxonomy (2026-07-02):** the two secondary doors became the four-door curated-entries band; the nav became the first-class entries (Shop Your State / Wall Art / The Book / Gifts / Catalog); the state page adopted the real type jump bar + "Complete the collection" band; a Wall Art band anchors the product merchandising at beat two.

**Night Gallery adopted (Richard, 2026-07-02):** after comparing against the merch proofs page (`merch/_proofs/index.html`), the art-forward surfaces adopted its dark-exhibition treatment (see §1) with the real photography. Light commerce frame retained; catalog and product-detail art surfaces are candidates for a follow-up pass. Equity A Caps is not web-licensed — EB Garamond small-caps stands in on the web.

**Landing hero — STANDING DECISION (Richard, 2026-07-02):** the **book is the hero.** A taxonomy-driven pass briefly promoted wall art to the hero slot (per the ★-hero column); Richard reversed it the same day. The ★-hero column governs *product* merchandising (wall art leads beat two, the catalog, and state pages) — **not** the landing hero, which is the brand statement. Do not "fix" this again without asking him.
